...
public class RepartidorDAO {
    ...
    public boolean existeRepartidor(int id) {
        String sql = "SELECT * FROM repartidor WHERE persona_id = ?";
    ...
    public boolean ingresarRepartidor(String usuario, String contrasena) {
    ...
    public int getUserId(String usuario, String contrasena) {
        String sql = "SELECT persona_id FROM repartidor WHERE usuario = ? AND contrasena = ?";
        try(Connection conn = DbConnection.getConnection();
